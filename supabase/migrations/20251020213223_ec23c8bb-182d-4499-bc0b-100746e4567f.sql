-- Create function to get trending hives based on RSVP count and recency
...
AS $$
  SELECT 
    ...
    -- Trending score: RSVPs * recency factor (newer events score higher)
...
-- Create function to find users with similar interests for connection suggestions
...
BEGIN
  ...
  WHERE 
    ...
    AND p.interests && ui.interests  -- Array overlap operator
